...
if (isset($_POST['column']) && $_POST['column'] != "") {
    ...
    $column = ShopPropertiesFilterSerchArray::ORDER_BY_COLUMN;
}
if (isset($_POST['asc_desc']) && $_POST['asc_desc'] != "") {
    $asc_desc = $_POST['asc_desc'];
} else {
    $asc_desc = ShopPropertiesFilterSerchArray::ORDER_BY_ASC_DESC;
}
ShopPropertiesFilterSerchArray::setOrderBy($group, $column, $asc_desc);