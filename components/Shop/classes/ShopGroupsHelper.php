...
class ShopGroupsHelper {
    ...
    public function __construct($showHidden=false) {
        $this->rootGroups = ShopGroupsDataHelper::getData('RootGroups');
        $this->groups = ShopGroupsDataHelper::getData('Groups');
        $this->groupsHierarchyData = ShopGroupsDataHelper::getData('GroupsHierarchy');
