...
if (isset($_POST)) {
    if ($_POST !== "") {
        ...
        $data["id"] = $propertyId;
        $elementContent = AP_WorkingWithShopCatalog_General::generationElement($data, true);
        $elementId = InteractiveListsPlugin::genereteElementId();
        echo InteractiveListsPlugin::listElementHtml($elementContent, $elementId);
    }
}
