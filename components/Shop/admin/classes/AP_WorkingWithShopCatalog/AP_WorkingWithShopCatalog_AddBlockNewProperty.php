 ...
 * @created 31.03.2016 10:17:55
 */
class AP_WorkingWithShopCatalog_AddBlockNewProperty extends AP_WorkingWithShopProperty_AddNewProperty {
    ...
    public function generationAJAX() {
        ...
        $html = '<script type="text/javascript">
                    ...
                    function shopAddNewGroupNewProperty() {
                        ...
                        $.ajax({
                            type: "POST",
                            url: "./components/Shop/admin/script/shopAddNewGroupNewProperty.php",
                            data: form_data,
                            cache: false,
                            success: function(result) {
                                        $(".addGroupCatalogGroupPropertyRight .SortsList").prepend(result);
                                        $(".addGroupCatalogNewPropertyNameInput #propertyName").val("");
                                        addGroupCatalogAddButtonEvent();
                            }
                        });
                    }
                </script>';
